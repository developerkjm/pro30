...
public interface BoardController {
	...
	public ResponseEntity addNewFee(MultipartHttpServletRequest multipartRequest, HttpServletResponse response) throws Exception;
	
	
	public ModelAndView addNewFee2(HttpServletRequest request, HttpServletResponse response) throws Exception;
